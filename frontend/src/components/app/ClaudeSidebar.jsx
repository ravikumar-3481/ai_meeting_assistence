...
export default function ClaudeSidebar({ 
  ...
  return (
    <aside
      className={`bg-zinc-950 dark:bg-zinc-950 light:bg-zinc-100 border-r border-zinc-800 flex flex-col justify-between transition-all duration-300 relative z-20 ${
        ...
        {!isCollapsed && (
          <div className="flex items-center gap-2.5 px-2">
            ...
            <div>
              ...
              <span className="text-[9px] font-mono text-emerald-400 font-semibold block">DB LIVE CONNECTED</span>
            </div>
          </div>
        )}
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-4">
        ...
        <div className="space-y-2">
          <button
            ...
            className={`w-full py-2.5 px-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs flex items-center justify-center gap-2 shadow-sm transition-all cursor-pointer ${
              isCollapsed ? 'p-2' : ''
            }`}
          >
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left p-2.5 rounded-xl text-xs transition-all cursor-pointer group flex items-start gap-2.5 ${
                        isActive
                          ? 'bg-zinc-850 text-white border border-indigo-500/60 shadow-sm'
                    ...
                    >
                      ...
                      <div className="flex-1 truncate">
                        ...
                        <div className="text-[10px] text-zinc-500 flex items-center gap-2 mt-0.5">
                          ...
                          <span>•</span>
                          <span className="text-indigo-400 uppercase font-mono">{m.language || 'EN'}</span>
                        </div>
                      </div>
                    </button>
                  );
