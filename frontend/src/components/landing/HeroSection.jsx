...
import { 
  Sparkles, ArrowRight, Play, CheckCircle2, Mic, Bot, 
  BrainCircuit, Users, Shield, Zap 
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex justify-center mb-6">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-zinc-900/90 border border-indigo-500/30 text-xs sm:text-sm text-zinc-300 shadow-xl shadow-indigo-500/10 backdrop-blur-md cursor-pointer hover:border-indigo-500/50 transition-colors"
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          <motion.h1 
            ...
            className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-zinc-100 leading-[1.1]"
          >
          ...
          >
            ...
            <button
              onClick={() => demoLogin()}
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-2xl text-base font-semibold text-amber-300 bg-amber-500/10 border border-amber-500/30 hover:bg-amber-500/20 hover:border-amber-500/50 transition-all cursor-pointer backdrop-blur-sm"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3.5 rounded-2xl text-sm font-medium text-zinc-300 hover:text-white bg-zinc-900/80 border border-zinc-800 hover:border-zinc-700 transition-all cursor-pointer"
            >
        ...
        >
          <div className="relative rounded-2xl p-1 bg-gradient-to-b from-indigo-500/40 via-zinc-800/60 to-zinc-900/90 shadow-2xl shadow-indigo-950/60 backdrop-blur-xl">
            <div className="rounded-[14px] bg-zinc-950 border border-zinc-800/80 overflow-hidden shadow-inner">
              ...
              <div className="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-12 gap-4 bg-zinc-950">
                ...
                {/* Left Sidebar Mock */}
                <div className="hidden md:block md:col-span-4 bg-zinc-900/60 rounded-xl p-3 border border-zinc-800/70 space-y-3">
                  <div className="text-xs font-semibold text-zinc-400 tracking-wider uppercase px-2">Active Session</div>
                  <div className="p-2.5 rounded-lg bg-zinc-800/80 border border-indigo-500/30 text-xs">
                    <div className="font-semibold text-zinc-100 flex items-center justify-between">
                      <span>Q3 Product & AI Roadmap</span>
                      <span className="text-[10px] text-indigo-400 bg-indigo-500/10 px-1.5 py-0.5 rounded">Live</span>
                    </div>
                  ...
                  <div className="space-y-1 pt-2">
                    ...
                    <div className="p-2 rounded bg-zinc-950/60 border border-zinc-800 text-[11px] text-zinc-300 flex items-start gap-2">
                      <input type="checkbox" checked readOnly className="mt-0.5 accent-indigo-500 rounded" />
                      <div>
                        <span className="line-through text-zinc-400">Benchmark WebRTC latency</span>
                        <span className="block text-[9px] text-indigo-400">Owner: Marcus Chen</span>
                      </div>
                    </div>
                    <div className="p-2 rounded bg-zinc-950/60 border border-zinc-800 text-[11px] text-zinc-300 flex items-start gap-2">
                      <input type="checkbox" readOnly className="mt-0.5 accent-indigo-500 rounded" />
                      <div>
                        <span>Draft API contracts for Slack hook</span>
                        <span className="block text-[9px] text-amber-400">Owner: Alex Rivera • Due Aug 16</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="md:col-span-8 space-y-3">
                  ...
                  <div className="flex items-start gap-2.5 justify-end">
                    <div className="bg-indigo-600/90 text-white rounded-2xl rounded-tr-none px-4 py-2.5 text-xs max-w-sm">
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 text-zinc-200 rounded-2xl rounded-tl-none p-4 text-xs space-y-2 max-w-md">
                      <div className="flex items-center gap-2 text-[10px] font-mono text-emerald-400 font-medium">
                        <Sparkles className="w-3 h-3" /> Claude 3.5 Sonnet Response
                      </div>
                      ...
                      <div className="p-2 rounded bg-zinc-950 font-mono text-[10px] text-indigo-300 border border-zinc-800/80">
